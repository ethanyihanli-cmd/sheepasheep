...
public class GameState {
    ...
    public ObservableList<Card> getBoardCards() { return boardCards; }
    public ObservableList<Card> getInventory() { return inventory; }
    public int getCurrentLevel() { return currentLevel.get(); }
    public IntegerProperty currentLevelProperty() { return currentLevel; }
    public void setCurrentLevel(int level) { this.currentLevel.set(level); }
    public int getScore() { return score.get(); }
    public IntegerProperty scoreProperty() { return score; }
    public void addScore(int points) { this.score.set(this.score.get() + points); }
    public boolean isGameWon() { return gameWon.get(); }
    public BooleanProperty gameWonProperty() { return gameWon; }
    public void setGameWon(boolean won) { this.gameWon.set(won); }
    public boolean isGameLost() { return gameLost.get(); }
    public BooleanProperty gameLostProperty() { return gameLost; }
    public void setGameLost(boolean lost) { this.gameLost.set(lost); }
    public boolean isInventoryFull() { return inventory.size() >= INVENTORY_CAPACITY; }
